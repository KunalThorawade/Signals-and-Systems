...
\author{Kunal Thorawade\\EE23BTECH11035}
\date{}
...
\begin{align}
    ...
    F	_{s2} &= 8.2+0.3 = 8.5  \text{KHz}
\end{align}
\begin{align}
    \omega_{s1} &= 2\pi\frac{F_{s1}}{F_s} = 0.2791 \pi\\
...
$\Omega_{p1} = 0.4930$, $\Omega_{p2} = 0.5950$ and $\Omega_{s1} = 0.4688$, $\Omega_{s2} = 0.6217$
respectively.
...
\begin{align}
    \Omega_{Ls1} &= \frac{\Omega_{s1}^2 - \Omega_0^2}{B\Omega_{s1}} = -1.5383\\
...
\begin{lstlisting}
https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
 https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/gain_LP.py
\end{lstlisting}
...
\begin{lstlisting}
   https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/HaLP_denom.py
\end{lstlisting}
\begin{align}
...
\begin{lstlisting}
    https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/plot2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
 https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/plot3.py
\end{lstlisting}
...
\begin{lstlisting}
   https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/filter_in_z.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
The lowpass filter has a passband frequency $\omega_l$ and transition band $\Delta \omega = 2\pi \frac{\Delta F}{F_s} = 0.051\pi$.
...
\end{enumerate}
\begin{lstlisting}
    https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/plot4.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
The code for plot:
\begin{lstlisting}
https://github.com/KunalThorawade/Signals-and-Systems/blob/main/Filter_Design/codes/plot5.py
\end{lstlisting}
\begin{figure}[H]
\centering
