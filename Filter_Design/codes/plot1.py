...
# Given parameters
epsilons = [0.3084, 0.45, 0.55, 0.6197]
...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.31', 'Epsilon = 0.45', 'Epsilon = 0.55', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
